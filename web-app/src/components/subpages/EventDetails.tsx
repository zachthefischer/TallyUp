...
export default function EventDetails({   
    ...
    useEffect(() => {
        console.log("EventDetails", activeSubGroup, activeSubSubGroup);
    ...
    return (
        <div className=" bg-white rounded-lg shadow-lg border border-gray-200">
              { activeSubGroup && activeSubSubGroup ? (
                <MembersList 
                  members={activeSubSubGroup}
                  groupName={activeSubGroup.groupName}
                  subCategoryName={activeSubSubGroup.groupName}
                  onEditMembers={() => {
                    // Here you would handle editing members
                    console.log('Editing members for:', activeSubSubGroup.groupName);
                  }}
                />
              ) : activeSubGroup ? (
                <div className="p-6">
